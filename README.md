...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/icy-rice-cf36)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/icy-rice-cf36
```

A live public deployment of this template is available at [https://icy-rice-cf36.templates.workers.dev](https://icy-rice-cf36.templates.workers.dev)
